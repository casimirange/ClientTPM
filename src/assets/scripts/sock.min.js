/**
 * Created by Casimir on 01/12/2020.
 */
...
!function (t) {
    ...
    return function i(s, a, l) {
        ...
        15: [function (t, e, n) {
            ...
            d(r, {
                bind: function (e) {
                    ...
                    for (var r = c.call(arguments, 1), t = Math.max(0, n.length - r.length), o = [],
                             i = 0; i < t; i++)o.push("$" + i);
        ...
        49: [function (t, e, n) {
            ...
            e.exports = {
                isObject: function (t) {
                    ...
                    for (var e, n, r = 1,
                             o = arguments.length; r < o; r++)for (n in e = arguments[r])Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
                    return t
                }
            }
        }, {}],
        50: [function (t, e, n) {
            ...
            e.exports = {
                string: function (t) {
                    for (var e = s.length, n = i.randomBytes(t), r = [],
                             o = 0; o < t; o++)r.push(s.substr(n[o] % e, 1));
                    return r.join("")
                }, number: function (t) {
                    ...
                    function W(t, l) {
                        ...
                        if (!d("json")) {
                            ...
                            if ((j = i.hasOwnProperty) || (j = function (t) {
                                ...
                                function L(t) {
                                    for (var e = '"', n = 0, r = t.length, o = !a || 10 < r,
                                             i = o && (a ? t.split("") : t); n < r; n++) {
                                ...
                                l.stringify = function (t, e, n) {
                                    ...
                                    if (q[typeof e] && e)if ((s = O.call(e)) == p) o = e; else if (s == A) {
                                        i = {};
                                        for (var a, l = 0,
                                                 c = e.length; l < c; a = e[l++], (s = O.call(a)) != N && s != C || (i[a] = 1));
                                    }
            ...
            (function (i) {
                ...
                function y(t, e, n) {
                    ...
                    n && (f.query = n(f.query)), r && e.slashes && "/" !== f.pathname.charAt(0) && ("" !== f.pathname || "" !== e.pathname) && (f.pathname = function (t, e) {
                        for (var n = (e || "/").split("/").slice(0, -1).concat(t.split("/")), r = n.length,
                                 o = n[r - 1], i = !1,
